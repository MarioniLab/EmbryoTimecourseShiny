  ...
  sidebarLayout(
    sidebarPanel(
      absolutePanel(
        ...
        downloadButton("downloadOverview", label = "Download overview vis"),
        downloadButton("downloadGeneTSNE", label = "Download gene expr. vis"),
        downloadButton("downloadGeneViolin", label = "Download gene expr. violins"),
        fixed = TRUE,
        left = "2%",
        top = "2%",
        width = paste0(20*2/3, "%")
