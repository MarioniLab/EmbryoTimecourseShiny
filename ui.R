  ...
  sidebarLayout(
    sidebarPanel(
      absolutePanel(
        ...
        downloadButton("downloadOverview", label = "Download overview t-SNE"),
        downloadButton("downloadGeneTSNE", label = "Download gene expression t-SNE"),
        downloadButton("downloadGeneViolin", label = "Download gene expression violins"),
        fixed = TRUE,
        left = "2%",
        top = "2%",
        width = paste0(20*2/3, "%")
